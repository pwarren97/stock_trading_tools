...
# Test 1
printf "Test 1:\n"
echo "./stt get_data -s tsla -d 20190102 --close_only"
./stt get_data -s tsla -d 20190102 --close_only

# Test 2
printf "\nTest 2:\n"
echo "./stt get_data -s MSFT -d 20190102 20190104 --close_only"
./stt get_data -s MSFT -d 20190101 20190104 --close_only
